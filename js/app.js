...
dimension = 7;
var arregloImagenes = ['image/1.png', 'image/2.png', 'image/3.png', 'image/4.png'];
var puntuacion = [10, 50, 75, 100, 150, 200, 250,300,325,350,375,400,425,450];
var numeroImagenes = arregloImagenes.length;
var matriz = [];
var movimiento = null;
var arrastre = null;
...
$(function () {
    ...
    function imagenAleatoria() {
        var imagenColocada = Math.floor((Math.random() * numeroImagenes));
        return arregloImagenes[imagenColocada];
    }
    ...
    function reiniciar() {
        ...
        actualizarPuntos();
        clearTimeout(tiempo);
        var cuadroTiempo = $('.time').css("display"); 
        if (cuadroTiempo ==='none'){
        ...
        for (var f = 0; f < dimension; f++)
        {
            for (var c = 0; c < dimension; c++)
            {
                ...
                if (matriz[f][c].respawn === true)
                {
                    ...
                    matriz[f][c].fuente = imagenAleatoria();
